...
gem5-19.0.0.0 已正式发布！
我们比计划晚了几个月，但未来的发布应该会更好。

gem5-19 发布的主要目标是测试我们的发布机制，以确保首次 ["RE-gem5"]({% post_url 2019-9-12-re-gem5 %}) 发布顺利进行。
从这个意义上说，gem5-19 是一个重大成功！
我们能够发现并解决发布方法中的几个错误。
我希望 gem5-20 发布不会出现任何问题 ;)。

下面是对 gem5-19 主要更改的讨论以及关于 gem5 发布的常见问题解答。
我们没有这个版本 gem5 的正式发布说明。
但是，所有未来的发布都将有正式的发布说明，详细说明与前一版本的差异。
